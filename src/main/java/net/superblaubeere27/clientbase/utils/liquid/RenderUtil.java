package net.superblaubeere27.clientbase.utils.liquid;
...
//        GL11.glEnable(GL_MULTISAMPLE);
    ...
    public static void drawCustomImage(float v, float v1, int i, int i1, ResourceLocation resourceLocation, int i2) {
        ...
        Gui.drawModalRectWithCustomSizedTexture((int)v, (int)v1, (int)0.0f, (int)0.0f, i, i1, (float) i, (float) i1);
...
//        GL11.glHint(3155, 4352);
    ...
    public static void drawVLine(float x, float y, float x1, int y1) {
        ...
        Gui.drawRect((int)x, (int)y + (int)1.0f, (int)x + (int)1.0f, (int)x1, (int)y1);
    }
    ...
    public static void drawHLine(float x, float y, float x1, int y1) {
        ...
        Gui.drawRect((int)x, (int)x1, (int)y + (int)1.0f, (int)x1 + (int)1.0f, y1);
    }
    ...
    public static void drawCustomImageAlpha(float v, float v1, int i, int i1, ResourceLocation resourceLocation, int i2, float alpha) {
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(resourceLocation);
        Gui.drawModalRectWithCustomSizedTexture((int)v, (int)v1, (int)0.0f, (int)0.0f, (int)i, (int)i1, (float) i, (float) i1);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
    }
	...
	public static void drawRect(int i, int j, int k, int l, int m) {
		Gui.drawRect(l, k, i, m, l);
		
	}

	public static void drawRect(float f, float g, float h, float i, Color color) {
		Gui.drawRect((int)f, (int)g, (int)h, (int)i, color.getRGB());
	}
