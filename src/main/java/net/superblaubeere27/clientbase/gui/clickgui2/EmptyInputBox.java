        ...
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                String s1 = flag ? s.substring(0, j) : s;
                            	Minecraft.getMinecraft().fontRendererObj.drawString(s1, (float) l, (float) i1, i, false);
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int)             	Minecraft.getMinecraft().fontRendererObj.drawString(s.substring(j), (float) j1, (float) i1, i, false);
            }
            ...
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1 + l, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                                	...
                                	Minecraft.getMinecraft().fontRendererObj.drawString("_", (float) k1, (float) i1, i, false);
                }
            }
